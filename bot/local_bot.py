...
TEXT = {
    "start": (
        ...
        "Он делает другое: считает, сколько человек играют теми же числами, "
        "что и вы. Джекпот делится между всеми, кто угадал, поэтому "
        "комбинация, которую не поставил больше никто, приносит при выигрыше "
        "в разы больше денег. Шанс выиграть при этом не меняется — и мы этого "
        "не обещаем."
    ),
    "help": (
        "Команды:\n"
